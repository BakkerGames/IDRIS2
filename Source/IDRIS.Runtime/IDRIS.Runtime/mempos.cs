...
namespace IDRIS.Runtime
{
    public static partial class mempos
    {
        ...
        public const int machtype = 109; //  x6d  = public constant 20 in idris;
        public const int sysrel = 110; //  x6e  = public constant 5 in idris;
        public const int sysrev = 111; //  x6f  = public constant 0 in idris;
